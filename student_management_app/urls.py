...
urlpatterns = [
    ...
    path('manage_room_area/', HodViews.manage_room_area, name="manage_room_area"),
    path('add_room_area/', HodViews.add_room_area, name="add_room_area"),
    path('add_room_area_save/', HodViews.add_room_area_save, name="add_room_area_save"),
    path('edit_room_area/<room_area_id>', HodViews.edit_room_area, name="edit_room_area"),
    path('edit_room_area_save/', HodViews.edit_room_area_save, name="edit_room_area_save"),
    path('delete_room_area/<room_area_id>/', HodViews.delete_room_area, name="delete_room_area"),
